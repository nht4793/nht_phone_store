...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                basePath: function() {
                    ...
                    if (!b)
                        for (var c = document.getElementsByTagName("script"), d = 0; d < c.length; d++) { var h = c[d].src.match(a); if (h) { b = h[1]; break } } - 1 == b.indexOf(":/") && "//" != b.slice(0, 2) && (b = 0 === b.indexOf("/") ? location.href.match(/^.*?:\/\/[^\/]*/)[0] +
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        function d() {
                            try { document.documentElement.doScroll("left") } catch (f) { setTimeout(d, 1); return }
                            a()
                        }
                        c.push(b);
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, k, h) {
                function p(a, f, B, h) { a = { name: b, sender: this, editor: a, data: f, listenerData: k, stop: B, cancel: h, removeListener: r }; return !1 === d.call(g, a) ? !1 : a.data }
    ...
    (function() {
        var a = [],
            ...
            p = function(a, f) { return "#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : h[f] };
        ...
        CKEDITOR.tools = {
            ...
            htmlDecode: function(a) { return a.replace(k, p) },
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) {
                    ...
                    if (d.test(c)) var m = "\x3c" + h + "\x3e",
                        p = "\x3c/" + h + "\x3e",
                        c = m + c.replace(d, function() { return p + m }) + p
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
                b || (c = c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function(a) { return CKEDITOR.tools.repeat(a, 2) }));
            ...
            tryThese: function() { for (var a, f = 0, b = arguments.length; f < b; f++) { var c = arguments[f]; try { a = c(); break } catch (h) {} } return a },
            ...
            parseCssText: function(a, f, b) {
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                    function(a, b, h) {
                        f && (b = b.toLowerCase(), "font-family" == b && (h = h.replace(/\s*,\s*/g, ",")), h = CKEDITOR.tools.trim(h));
                        c[b] = h
                    });
                return c
            },
            ...
            enableHtml5Elements: function(a,
                b) { for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), h = c.length, d; h--;) d = a.createElement(c[h]), b && a.appendChild(d) },
            ...
            array: {
                ...
                reduce: function(a, b, c, h) { for (var d = 0; d < a.length; d++) c = b.call(h, c, a[d], d, a); return c }
            }
        };
    ...
    CKEDITOR.dtd = function() {
        var a = CKEDITOR.tools.extend,
            d = function(a, b) { for (var c = CKEDITOR.tools.clone(a), h = 1; h < arguments.length; h++) { b = arguments[h]; for (var d in b) delete c[d] } return c },
            b = {},
            c = {},
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getName: function() {
                ...
                if (CKEDITOR.env.ie && 8 >= document.documentMode) { var b = this.$.scopeName; "HTML" != b && (a = b.toLowerCase() + ":" + a) }
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = u ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = e.left + b - x, c = e.top + c - m)
                } else
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function x(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 }!a && (a = this.getWindow());
                e = a.getDocument();
            ...
            disableContextMenu: function() {
                function a(b) { return b.type == CKEDITOR.NODE_ELEMENT && b.hasClass("cke_enable_context_menu") }
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return (!b || !C.equals(a)) && (!h || !a.equals(h)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) }
            }
            var k = a ? this._.guardRTL : this._.guardLTR;
            g = l ? function(a, b) { return !1 === k(a, b) ? !1 : l(a, b) } : k;
        ...
        function d(b) { for (var c, f = null; c = a.call(this, b);) f = c; return f }
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
            ...
            p = function(a) { return k(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
        CKEDITOR.dom.walker.ignored =
            function(a) { return function(b) { b = g(b) || k(b) || h(b); return !!(a ^ b) } };
    ...
    (function() {
            ...
            if (l && n.type == CKEDITOR.NODE_TEXT && q.equals(n)) q = a.document.createText(q.substring(t, A)), c.append(q);
                ...
                for (S = G; S <= I; S++)
                    if (c = v[S], X = c.getPrevious(), c.equals(P[S])) b && (K = K.getChild(0));
                        ...
                        S != I || c.equals(P[S]) && I < E ? b && (L = K.append(c.clone(0, e))) : D ? m(c, K, !1, H) : Q && K.append(a.document.createText(c.substring(0, A)));
                        if (S > fa)
                            for (; X;) X = m(X, K, !0);
                        K = L
                    }
        ...
        function e(a) {
            return function() {
                var b;
                return this[a ?
                    "getPreviousNode" : "getNextNode"](function(a) {!b && r(a) && (b = a); return p(a) && !(k(a) && a.equals(b)) })
            }
        }
                ...
                switch (a) {
                                        ...
                                        if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                            ...
                                            if (d.test(C)) q = null;
                                                ...
                                                for (var D = q.$.getElementsByTagName("*"), M = 0, H; H =
                                                    D[M++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[H.nodeName.toLowerCase()]) { q = null; break }
                                            q && (A = !!C.length)
                                        } else q = null;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var p, Q, P = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            ...
                            G = function(a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (v) { if (v.equals(a)) { v = null; return } } else v = a;
                                else if (v) return;
                                var b = P(a);
                                b || (p = a);
                                return b
                            },
                            e = function(a) { var b = G(a);!b && a.is && a.is("br") && (Q = a); return b };
                        l.guard = G;
                        l = l.lastBackward();
                        p = p || h;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            ...
                            l.evaluator = function(a) { return !E(a) && !I(a) };
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; x;) {
                    ...
                    if (F) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (F = 0);
                        ...
                        var q = x.getName();
                        if (CKEDITOR.dtd.$block[q] && "false" == x.getAttribute("contenteditable")) {
                            d = x;
                            b(this, a, d);
                            break
                            ...
                            if (x.getFirst()) {
                                k || (k = this.range.clone(), k.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
                                x = x.getFirst();
                                continue
                            }
                            F = 1
    ...
    (function() {
        ...
        function h(a, b) {
            ...
            if (l = a.requiredClasses)
                for (e = b.classes, c = 0; c < l.length; ++c)
                    if (d = l[c], "string" == typeof d) { if (-1 == CKEDITOR.tools.indexOf(e, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(e, d)) return !1;
        ...
        function B(a, b) { var c = a.match(G[b]); return c ? H(c[1]) : null }
        ...
        function J(a) { if (!a) return !1; if (!0 === a) return !0; var b = y(a); return function(c) { return c in a || b && c.match(b) } }

        function w() { return new CKEDITOR.htmlParser.element("br") }
                ...
                if ("br" == b) a.previous && !F(a.previous) && (b = w(), b.insertBefore(a)), a.next && !F(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren();
                    ...
                    b: {
                        ...
                        for (var e = 0, q = d.length, n; e < q; ++e)
                            if (n = d[e], n.type == CKEDITOR.NODE_ELEMENT && !l[n.name]) { l = !1; break b }
                        l = !0
                    }
        ...
        function q(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (l = c[d], !(l.check && !a.check(l.check, !1) || l.left && !l.left(b))) { l.right(b, K); break }
        }
        ...
        function n(a, b) {
            ...
            for (e in d)
                if ("class" == e)
                    for (c = d[e].split(/\s+/), n = a.classes.join("|"); t = c.pop();) { if (-1 == n.indexOf(t)) return !1 } else if (a.attributes[e] != d[e]) return !1;
            for (q in l)
                if (a.styles[q] !=
                    l[q]) return !1;
            return !0
        ...
        function t(a, b) { var c, d; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a : (c = a[0], d = a[1]); return [{ element: c, left: d, right: function(a, c) { c.transform(a, b) } }] }

        function A(a) { return function(b) { return n(b, a) } }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (l = 0; l < b.length; ++l) e = this.allow(b[l], c, d); return e }
        ...
        K = CKEDITOR.filter.transformationsTools = {
            ...
            alignmentToStyle: function(a) {
                if (!("float" in a.styles)) { var b = a.attributes.align; if ("left" == b || "right" == b) a.styles["float"] = b }
                delete a.attributes.align
            },
            alignmentToAttribute: function(a) {
                if (!("align" in a.attributes)) { var b = a.styles["float"]; if ("left" == b || "right" == b) a.attributes.align = b }
                        ...
                        z = function(b) {
                            if (a[b]) B(b, !0);
                                ...
                                if (!(1 < e.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function() { if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, u(b, !0) } : (f.$.onload = function() { setTimeout(function() { u(b, !0) }, 0) }, f.$.onerror = function() { u(b, !1) }));
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++z; while (CKEDITOR.instances[a]); return a }
        ...
        function g(a, b, c) { if (b) { var d, e, l = a.commands; for (e in l) d = l[e], (c || d.contextSensitive) && d.refresh(a, b) } }
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, e, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (e = c[1])
                        if (e = e.toLowerCase(), k && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(k.join("")), k = null), !k) { this.onTagClose(e); continue }
                    if (k) k.push(c[0]);
                    else if (e = c[3]) {
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, k, h) {
                ...
                function r() { for (; J.length;) B(J.shift(), w) }
                ...
                function z(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 }
                ...
                y.onTagOpen = function(e, n, f, g) {
                    ...
                    if (a(n)) x.push(n);
                        ...
                        if ("pre" == e) l = !0;
                        else { if ("br" == e && l) { w.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (F = !0) }
                        if ("br" == e) J.push(n);
                        else {
                ...
                y.onTagClose = function(a) {
                    for (var b = x.length - 1; 0 <= b; b--)
                        if (a == x[b].name) { x.splice(b, 1); return }
    ...
    (function() {
        ...
        function d(b, c, d, g) { var k, h; for (k in c)(h = b[k]) || (h = b[k] = new a), h.add(c[k], d, g) }
            ...
            proto: {
                ...
                onElement: function(a, c) {
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], g, k = 0; 3 > k; k++)
                        if (g = d[k]) { g = g.exec(a, c, this); if (!1 === g) return null; if (g && g != c) return this.onNode(a, g); if (c.parent && !c.name) break }
                    return c
                },
    ...
    (function() {
        ...
        function r(a) {
            return a.replace(C,
                function(a, b, c) { return "\x3c" + b + c.replace(D, function(a, b) { return M.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        }

        function f(a, b) { return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) }

        function B(a) { return a.replace(Q, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function z(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }) }

        function y(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function(a, b) { return c && c[b] || "" }) }
        ...
        function m(a, b) {
            ...
            for (var f = 0; f < d.length; f++) a = a.replace(d[f], function(a) { a = a.replace(e, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
            a = a.replace(e, function(a, b, d) {
                return "\x3c!--" + J + (b ? "{C}" :
                    "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\x3e"
            });
            a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function(a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function(a, b) { l[l.id] = decodeURIComponent(b); return "{cke_protected_" + l.id++ + "}" }) });
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, l) { return "\x3c" + c + d + "\x3e" + y(z(l), b) + "\x3c/" + c + "\x3e" })
        }
        ...
        var x = /(?:&nbsp;|\xa0)$/,
            ...
            A = {
                ...
                elements: {
                    $: function(a) { var b = a.attributes; if (b) { if (b["data-cke-temp"]) return !1; for (var c = ["name", "href", "src"], d, l = 0; l < c.length; l++) d = "data-cke-saved-" + c[l], d in b && delete b[c[l]] } return a },
                    table: function(a) {
    ...
    (function() {
        ...
        CKEDITOR.template = function(g) {
            if (a[g]) this.output = a[g];
                ...
                var k = g.replace(b, "\\$1").replace(c, "\\n").replace(e, "\\r").replace(d, function(a, b) { return "',data['" + b + "']\x3d\x3dundefined?'{" + b + "}':data['" + b + "'],'" });
    ...
    (function() {
        ...
        CKEDITOR.replaceAll = function() {
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                var d = null,
                    k = a[b];
                if (k.name || k.id) {
                    if ("string" == typeof arguments[0]) { if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(k.className)) continue } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](k, d))) continue;
                    this.replace(k, d)
                }
            }
        };
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    ...
                    "source" == d.mode && k == p && (d.fire("lockSnapshot", { forceUpdate: !0 }), r = 1);
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
            ...
            k = k ? this.container.getFirst(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : h;
            k.setSize("width", a, !0);
            r && (r.style.width = "1%");
    ...
    (function() {
        function a(a) {
            ...
            k(b, e.block, f) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (e = h.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function(a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
        ...
        function g(a) {
            function b(a) { return function(b, l) { l && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b); if (!(l || !c(b) || a && z(b))) return !1 } }
        ...
        function h(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                focus: function() {
                    var a;
                    if (CKEDITOR.env.webkit && !this.hasFocus && (a = this.editor._.previousActive || this.getDocument().getActive(), this.contains(a))) { a.focus(); return }
                    ...
                    } catch (b) { if (!CKEDITOR.env.ie) throw b; }
                ...
                insertElement: function(a, b) {
                    ...
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a,
                        CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) { return c(a) && !z(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));
                    d.selectRanges([b]);
                    p(this)
                },
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) l = !0;
                                ...
                                if (CKEDITOR.env.webkit && (l = c.getDocument().getActive()) && l.equals(c) && !d.anchorNode) { l = !0; break a }
                                l = void 0
                            }
                    ...
                    function b() {
                        ...
                        "None" == d.type && l.equals(c) && (d = new CKEDITOR.dom.range(c), a = a.body.createTextRange(), d.moveToElementEditStart(c), d = d.startContainer, d.type != CKEDITOR.NODE_ELEMENT && (d = d.getParent()), a.moveToElementText(d.$), a.collapse(!0), a.select())
                    }
                    var c = this;
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    } else c.autoParagraph(this.editor, a), u(a.startContainer) && a.startContainer.appendBogus();
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b = this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(y, function(a, b) { return b }));
                        a.setData(b, null, 1)
                    }, this);
            ...
            _: {
                detach: function() {
                    ...
                    if (!this.is("textarea")) { a = this.getDocument(); var b = a.getHead(); if (b.getCustomData("stylesheet")) { var c = a.getCustomData("stylesheet_ref");--c ? a.setCustomData("stylesheet_ref", c) : (a.removeCustomData("stylesheet_ref"), b.removeCustomData("stylesheet").remove()) } }
        ...
        m = function() {
            ...
            function f(b) { return b && a(b) && (b.is(p.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }
                ...
                if (!E.checkReadOnly()) {
                    ...
                    if (H = G) {
                        ...
                        if ((z = H.startPath().block) && (1 != z.getChildCount() || !z.getBogus())) a: {
                            var w;
                            if (1 ==
                                u.getChildCount() && a(w = u.getFirst()) && w.is(r) && !w.hasAttribute("contenteditable")) {
                    ...
                    if (!m.dontMoveCaret) {
                        for (N = e(O); N && a(N) && !N.is(p.$empty);) {
                            if (N.isBlockBoundary()) O.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(N) && N.getHtml().match(/(\s|&nbsp;)$/g)) { T = null; break }
                                T = O.clone();
    ...
    (function() {
        ...
        function c(a) { return J(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 }
        ...
        function h(a, b) { return b ? a.replace(y, function(a, b) { return b ? " " : "" }) : a.replace(z, "") }
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && g.attachListener(g, "focus",
                    function(a) {
                        a.removeListener();
                        0 !== p && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(), a.moveToElementEditStart(g), a.select())
                    }, null, null, -2);
                g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() {
                    p && CKEDITOR.env.webkit && (p = e._.previousActive && e._.previousActive.equals(f.getActive())) && null != e._.previousScrollTop && e._.previousScrollTop != g.$.scrollTop && (g.$.scrollTop = e._.previousScrollTop);
                    e.unlockSelection(p);
                    p = 0
                }, null, null, -1);
                g.attachListener(g,
                    "mousedown",
                    function() { p = 0 });
                if (CKEDITOR.env.ie || m) B ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
                    e.lockSelection(v);
                    p = 1
                }, null, null, -1), g.attachListener(g, "mousedown", function() { p = 0 });
                if (CKEDITOR.env.ie && !m) {
                    ...
                    g.attachListener(g, "mouseup", function(a) {
                        2 == a.data.$.button && G && (e.document.$.documentElement.scrollLeft = G.x, e.document.$.documentElement.scrollTop = G.y);
                        G = null
                    });
            ...
            e.on("key", function(a) { if ("wysiwyg" == e.mode) { var b = e.getSelection(); if (b.isFake) { var c = w[a.data.keyCode]; if (c) return c({ editor: e, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
        });
        ...
        CKEDITOR.editor.prototype.lockSelection = function(a) { a = a || this.getSelection(1); return a.getType() != CKEDITOR.SELECTION_NONE ? (!a.isLocked && a.lock(), this._.savedSelection = a, !0) : !1 };
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function() { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = B ? this.document.$.selection : this.document.getWindow().$.getSelection() },
            getType: B ? function() {
                var a = this._.cache;
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < g;) try {
                            l = f[0 < n ? "previousSibling" : "nextSibling"], l.nodeType == CKEDITOR.NODE_TEXT && (g -= l.nodeValue.length,
                                m = l), f = l
                        } catch (p) { return { container: d, offset: a(f) } }
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && F[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ });
                        ...
                        if (h) this.fake(h);
                            ...
                            if (B) {
                                ...
                                if ((c = h.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                                    c.getName() in F && (!c.is("a") || !c.getText())) try {
                                ...
                                for (y = 0; y < a.length; y++) {
                                    if (y < a.length - 1 && (r = a[y], u = a[y + 1], m = r.clone(), m.setStart(r.endContainer, r.endOffset), m.setEnd(u.startContainer, u.startOffset), !m.collapsed && (m.shrink(CKEDITOR.NODE_ELEMENT, !0), h = m.getCommonAncestor(), m = m.getEnclosedNode(), h.isReadOnly() || m && m.isReadOnly()))) {
    ...
    (function() {
            ...
            if (c.collapsed) f = J(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (u.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
                    ...
                    if (u.equals(r)) u = null, k = !0;
                        ...
                        if (z && u.data("cke-bookmark")) { u = u.getNextSourceNode(!0); continue }
        ...
        function u(a, b) {
            ...
            for (var d = 0; d < a.length; d++) {
                var e = a[d],
                    ...
                    e = B(e, /^[ \t]*\n/, ""),
                    e = B(e, /\n$/, ""),
                    e = B(e, /^[ \t]+|[ \t]+$/g, function(a, b) { return 1 == a.length ? "\x26nbsp;" : b ? " " + CKEDITOR.tools.repeat("\x26nbsp;", a.length - 1) : CKEDITOR.tools.repeat("\x26nbsp;", a.length - 1) + " " }),
                    e = e.replace(/\n/g, "\x3cbr\x3e"),
        ...
        function F(a,
            b) { for (var c in a) a[c] = a[c].replace(M, function(a, c) { return b[c] }) }
        ...
        CKEDITOR.style.prototype = {
            ...
            applyToRange: function(a) { this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? h : this.type == CKEDITOR.STYLE_OBJECT ? g : null; return this.applyToRange(a) },
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? p : this.type == CKEDITOR.STYLE_OBJECT ? k : null; return this.removeFromRange(a) },
                ...
                switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var c = a.elements, d = 0, e; d < c.length; d++)
                            if (e = c[d], this.type != CKEDITOR.STYLE_INLINE || e != a.block && e != a.blockLimit) { if (this.type == CKEDITOR.STYLE_OBJECT) { var f = e.getName(); if (!("string" == typeof this.element ? f == this.element : f in this.element)) continue } if (this.checkElementRemovable(e, !0, b)) return !0 }
                }
                return !1
            },
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? n(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1;
                        if (b) return !0
                    } else return !0
                }
                return !1
                ...
                if (b = l(this)[a.getName()]) {
                    ...
                    for (c = 0; c < b.length; c++)
                        if (d = b[c][0], d = a.getAttribute(d)) {
                            var e = b[c][1];
                            if (null === e) return !0;
                            if ("string" == typeof e) { if (d == e) return !0 } else if (e.test(d)) return !0
                        }
                }
                return !1
            },
                ...
                if (p.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!k && (r = p.getName(),
                        ...
                        if (r = !g && "div" == r) {
                            a: {
                                r = p.getChildren();
                                for (var f = 0, B = r.count(); f < B; f++) { var u = r.getItem(f); if (u.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[u.getName()]) { r = !0; break a } }
                                r = !1
                            }
                            r = !r
                        }
    ...
    (function() {
        ...
        var d = {
            ...
            createBookmarks: function(b) { for (var c = [], d, g = 0; g < this.length; g++) { c.push(d = this[g].createBookmark(b, !0)); for (var k = g + 1; k < this.length; k++) this[k] = a(d, this[k]), this[k] = a(d, this[k], !0) } return c },
            createBookmarks2: function(a) {
                for (var c = [], d = 0; d <
    ...
    */
    ...
    (function() {
        ...
        var aa = { resizable: CKEDITOR.DIALOG_RESIZE_BOTH, minWidth: 600, minHeight: 400, buttons: [CKEDITOR.dialog.okButton, CKEDITOR.dialog.cancelButton] },
            ...
            E = function(a, b, c, e, d) {
                if (c) { for (var f = 0, g; g = a[f]; f++) { if (g.id == c) return a.splice(f, 0, b), b; if (e && g[e] && (g = E(g[e], b, c, e, !0))) return g } if (d) return null }
                a.push(b);
                return b
            },
                ...
                if (c) {
                    ...
                    if (CKEDITOR.env.ie) {
                        ...
                        if (e && "blockquote" == e.getParent().getName())
                            for (d = e; d = d.getNext();)
                                if (d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary()) { e.move(d, !0); break }
                        if (b && "blockquote" == b.getParent().getName())
                            for (d = b; d = d.getPrevious();)
                                if (d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary()) { b.move(d); break }
                    }
                        ...
                        for (b = e.length - 1; 0 <= b; b--) {
                            ...
                            a: {
                                ...
                                for (var f = 0, m = d.getChildCount(), l = void 0; f < m && (l = d.getChild(f)); f++)
                                    if (l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) { d = !1; break a }
                                d = !0
                            }
                            d && c.remove()
                        }
    ...
    (function() {
        ...
        function z(b) {
            ...
            function e() {
                return {
                    ...
                    exec: function(b, a) {
                        ...
                        "string" == typeof a ? d({ dataValue: a, method: "paste", dataTransfer: m.initPasteDataTransfer() }, 1) : b.getClipboardData(d)
                    }
                }
            }
            ...
            function u(a) {
                ...
                d && m.canClipboardApiBeTrusted(c.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function() { q(b, c) }, 0)) : n(a, function(a) {
            ...
            (function() {
                ...
                b.contextMenu && b.contextMenu.addListener(function(b, a) { x = a.getRanges()[0].checkReadOnly(); return { cut: t("cut"), copy: t("copy"), paste: t("paste") } })
            })();
            (function() {
            ...
            b.getClipboardData = function(a, c) {
                ...
                !1 === w() && (b.removeListener("paste", d), h && b.fire("pasteDialog",
                    e) ? (b.on("pasteDialogCommit", g), b.on("dialogHide", function(a) {
                    a.removeListener();
                    a.data.removeListener("pasteDialogCommit", g);
                    setTimeout(function() { f || c(null) }, 10)
                })) : c(null))
            }
        }
        ...
        function B(b, a) {
            function c(a) { return CKEDITOR.tools.repeat("\x3c/p\x3e\x3cp\x3e", ~~(a / 2)) + (1 == a % 2 ? "\x3cbr\x3e" : "") }
            ...
            CKEDITOR.env.webkit && -1 < a.indexOf("\x3cdiv\x3e") && (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "\x3cbr\x3e").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "\x3cdiv\x3e\x3c/div\x3e"),
                a.match(/<div>(<br>|)<\/div>/) && (a = "\x3cp\x3e" + a.replace(/(<div>(<br>|)<\/div>)+/g, function(a) { return c(a.split("\x3c/div\x3e\x3cdiv\x3e").length + 1) }) + "\x3c/p\x3e"), a = a.replace(/<\/div><div>/g, "\x3cbr\x3e"), a = a.replace(/<\/?div>/g, ""));
            CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "\x3cbr\x3e")), -1 < a.indexOf("\x3cbr\x3e\x3cbr\x3e") && (a = "\x3cp\x3e" + a.replace(/(<br>){2,}/g, function(a) { return c(a.length / 4) }) + "\x3c/p\x3e"));
            return C(b, a)
        }
        ...
        function C(b, a) { b.enterMode == CKEDITOR.ENTER_BR ? a = a.replace(/(<\/p><p>)+/g, function(a) { return CKEDITOR.tools.repeat("\x3cbr\x3e", a.length / 7 * 2) }).replace(/<\/?p>/g, "") : b.enterMode == CKEDITOR.ENTER_DIV && (a = a.replace(/<(\/)?p>/g, "\x3c$1div\x3e")); return a }
        ...
        function F(b) {
            ...
            b.on("contentDom", function() {
                ...
                function g(a) { a.type != CKEDITOR.NODE_ELEMENT && (a = a.getParent()); return a.getChildCount() }
                var d = b.editable(),
            ...
            init: function(b) {
                ...
                b.on("paste", function(a) {
                    ...
                    if (!a.data.dataValue) {
                        ...
                        else if (c = d.getData("text/plain")) a.data.dataValue = b.editable().transformPlainTextToHtml(c), a.data.type = "text"
                    }
                }, null, null, 1);
                b.on("paste", function(a) {
                        ...
                        CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(b, d) { return d.toLowerCase() in c ? (a.data.preSniffing = "html", "\x3c" + d) : b }) : CKEDITOR.env.webkit ? b = b.replace(/<\/(\w+)><div><br><\/div>$/, function(b, d) { return d in c ? (a.data.endsWithEOL = 1, "\x3c/" + d + "\x3e") : b }) : CKEDITOR.env.gecko && (b = b.replace(/(\s)<br>$/, "$1"));
                        a.data.dataValue = b
                    }, null,
                    null, 3);
                b.on("paste", function(a) {
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            ...
            setData: function(b, a) {
                b = this._.normalizeType(b);
                this._.data[b] = a;
                if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == b || "Text" == b) { "Text" == p && "Text" == b && (this.id = a); try { this.$.setData(b, a) } catch (c) {} }
            },
            ...
            getFile: function(b) { return this._.files.length ? this._.files[b] : this.$ && this.$.files && this.$.files.length ? this.$.files[b] : 0 === b ? this._getImageFromClipboard() : void 0 },
            isEmpty: function() {
                var b = {},
                    a;
                ...
                this.getHolderElement = function() {
                    ...
                    if (!a) {
                        if (this.isFramed) {
                            ...
                            b = CKEDITOR.tools.addFunction(CKEDITOR.tools.bind(function() { this.isLoaded = !0; if (this.onLoad) this.onLoad() }, this));
            ...
            proto: {
                ...
                showBlock: function(a, b, c, l, h, g) {
                    ...
                    this._.blurSet || (CKEDITOR.event.useCapture = !0, e.on("blur", function(a) {
                            ...
                            this.hideChild();
                            this.allowBlur(!0)
                        }, this), CKEDITOR.env.iOS && (e.on("touchstart", function() { clearTimeout(this._.hideTimeout) }, this), e.on("touchend", function() {
                            this._.hideTimeout = 0;
                            this.focus()
                        }, this)), CKEDITOR.event.useCapture = !1,
                        this._.blurSet = 1);
                    m.onEscape = CKEDITOR.tools.bind(function(a) { if (this.onEscape && !1 === this.onEscape(a)) return !1 }, this);
                    CKEDITOR.tools.setTimeout(function() {
    ...
    CKEDITOR.plugins.add("menu", {
        ...
        beforeInit: function(l) {
            ...
            l.addMenuItems = function(a) { for (var b in a) this.addMenuItem(b, a[b]) };
            l.getMenuItem = function(a) { return t[a] };
            l.removeMenuItem = function(a) { delete t[a] }
        }
    });
    (function() {
        function l(a) { a.sort(function(a, d) { return a.group < d.group ? -1 : a.group > d.group ? 1 : a.order < d.order ? -1 : a.order > d.order ? 1 : 0 }) }
            ...
            _: {
                onShow: function() {
                    ...
                    for (var g = 0; g < m.length; g++) {
                        var k = m[g](b, a, d);
                        if (k)
                            for (var e in k) { var f = this.editor.getMenuItem(e);!f || f.command && !this.editor.getCommand(f.command).state || (f.state = k[e], this.add(f)) }
                    }
                },
                onClick: function(a) {
                    this.hide();
            ...
            proto: {
                ...
                show: function(a, b, d, m) {
                    ...
                    if (!e) {
                        ...
                        e.onEscape = CKEDITOR.tools.bind(function(a) { if (!1 === this._.onEscape(a)) return !1 }, this);
                        ...
                        a.on("contextmenu", function(a) {
                            ...
                            if (!e || !c) {
                                ...
                                if (CKEDITOR.env.mac && CKEDITOR.env.webkit) {
                                    var c = this.editor,
                                        b = (new CKEDITOR.dom.elementPath(a.getTarget(), c.editable())).contains(function(a) { return a.hasAttribute("contenteditable") }, !0);
    ...
    (function() {
        function D(a) {
            ...
            function c(c, e) { if (e.length) { c.items ? c.items.push(a.ui.create("-")) : c.items = []; for (var f; f = e.shift();) f = "string" == typeof f ? f : f.name, b && -1 != CKEDITOR.tools.indexOf(b, f) || (f = a.ui.create(f)) && a.addFeature(f) && c.items.push(f) } }
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function(a, d, g) {
            ...
            if (g) {
                if (g = CKEDITOR.tools.search(c, function(a) {
                    ...
                    !g.groups && (g.groups = []);
                    if (d && (d = CKEDITOR.tools.indexOf(g.groups, d), 0 <= d)) { g.groups.splice(d + 1, 0, a); return }
    ...
    (function() {
        ...
        function k(a) { a += ""; return a.charAt(0).toUpperCase() + a.substr(1) }
        ...
        onLoad: function() {
            ...
            CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
                ...
                _: {
                    ...
                    getClick: function() {
                        this._.click ||
                            (this._.click = CKEDITOR.tools.addFunction(function(a) { var b = this.toggle(a); if (this.onClick) this.onClick(a, b) }, this));
                        return this._.click
                    }
                },
                proto: {
                    ...
                    focus: function(a) {
                        ...
                        var b = this.element.getElementsByTag("a"),
                            c, d = -1;
                        if (a)
                            for (c = this.element.getDocument().getById(this._.items[a]).getFirst(); a = b.getItem(++d);) { if (a.equals(c)) { this._.focusIndex = d; break } } else this.element.focus();
                ...
                render: function(a, b) {
                    ...
                    var d =
                        ...
                        c = {
                            id: h,
                            combo: this,
                            focus: function() { CKEDITOR.document.getById(h).getChild(1).focus() },
                            execute: function(c) {
                                var b = f._;
        ...
        init: function(a) {
            if (!a.blockless) {
                ...
                0 !== m && a.ui.addRichCombo("Format", {
                    ...
                    onOpen: function() { this.showAll(); for (var b in d) a.activeFilter.check(d[b]) || this.hideItem(b) },
                    refresh: function() {
                        var b = a.elementPath();
                        if (b) {
                            if (b.isContextFor("p"))
    ...
    (function() {
        function e(b, a) { a || (a = b.getSelection().getSelectedElement()); if (a && a.is("img") && !a.data("cke-realelement") && !a.isReadOnly()) return a }
        ...
        CKEDITOR.plugins.add("image", {
            ...
            init: function(b) {
                if (!b.plugins.image2) {
                    ...
                    b.contextMenu && b.contextMenu.addListener(function(a) { if (e(b, a)) return { image: CKEDITOR.TRISTATE_OFF } })
                }
            },
            afterInit: function(b) {
                function a(a) {
    ...
    (function() {
        ...
        function t(c) { return c.type == CKEDITOR.NODE_ELEMENT && c.is("li") }

        function x(c) { return y(c) && z(c) }
        ...
        CKEDITOR.plugins.add("indentlist", {
            ...
            init: function(c) {
                function f(c) {
                    ...
                    c.on("key",
                        function(f) { if ("wysiwyg" == c.mode && f.data.keyCode == this.indentKey) { var n = this.getContext(c.elementPath());!n || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c.elementPath(), n) || (c.execCommand(this.relatedGlobal), f.cancel()) } }, this);
    ...
    (function() {
        ...
        function q(c) { for (var b, a = c.length, f = [], e = 0; e < a; e++) b = c.charCodeAt(e), f.push(b); return "String.fromCharCode(" + f.join(",") + ")" }
        ...
        CKEDITOR.plugins.link = {
            ...
            fakeAnchor: !0,
            tryRestoreFakeAnchor: function(c, b) { if (b && b.data("cke-real-element-type") && "anchor" == b.data("cke-real-element-type")) { var a = c.restoreRealElement(b); if (a.data("cke-saved-name")) return a } },
            parseLinkAttributes: function(c, b) {
                var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    ...
                    d, g = {};
                a.match(t) && ("encode" == e ? a = a.replace(A, function(a, b, c) { c = c || ""; return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'") }) : e && a.replace(B, function(a, b, c) {
                    if (b == f.name) {
                        g.type = "email";
                        a = g.email = {};
                        b = /(^')|('$)/g;
            ...
            showDisplayTextForElement: function(c, b) { var a = { img: 1, table: 1, tbody: 1, thead: 1, tfoot: 1, input: 1, select: 1, textarea: 1 }; return b.widgets && b.widgets.focused ? !1 : !c || !c.getName || !c.is(a) }
        };
    ...
    (function() {
        function V(a, c, d) { return n(c) && n(d) && d.equals(c.getNext(function(a) { return !(E(a) || F(a) || u(a)) })) }
        ...
        function O(a) { var c = a.element; if (c && n(c) && (c = c.getAscendant(a.triggers, !0)) && a.editable.contains(c)) { var d = P(c); if ("true" == d.getAttribute("contenteditable")) return c; if (d.is(a.triggers)) return d } return null }
        ...
        function q(a, c, d) { return a > c && a < d }
        ...
        function A(a, c) { if (!c || c.type != CKEDITOR.NODE_ELEMENT || !c.$) return !1; var d = a.line; return d.wrap.equals(c) || d.wrap.contains(c) }
        ...
        function ba(a) { return !!{ absolute: 1, fixed: 1 }[a.getComputedStyle("position")] }

        function L(a, c) { return n(c) ? c.is(a.triggers) : null }
        ...
        function na(a,
            c, d) {
            c = c[d ? "getLast" : "getFirst"](function(b) { return a.isRelevant(b) && !b.is(oa) });
            if (!c) return !1;
            r(a, c);
        ...
        function ca(a) {
            ...
            var f = d.y > (a.inInlineMode ? b.editable.top + b.editable.height / 2 : Math.min(b.editable.height, b.pane.height) / 2),
                c = c[f ? "getLast" : "getFirst"](function(a) { return !(E(a) || F(a)) });
            if (!c) return null;
            A(a, c) && (c = a.line.wrap[f ? "getPrevious" : "getNext"](function(a) { return !(E(a) || F(a)) }));
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function(a) {
                var c = a.config,
                    ...
                    e, f, k;
                b.isRelevant = function(a) { return n(a) && !A(b, a) && !u(a) };
        ...
        z.prototype = { set: function(a, c, d) { this.properties = a + c + (d || x); return this }, is: function(a) { return (this.properties & a) == a } };
        var ha = function() {
                function a(a, d) { var b = a.$.elementFromPoint(d.x, d.y); return b && b.nodeType ? new CKEDITOR.dom.element(b) : null }
            ...
            ia = function() {
                function a(a) {
                    ...
                    k = pa(a, function(a, b) { return !b.equals(a) }, function(a, b) { return ha(a, !0, b) }, b);
                    e = k.upper;
                    f = k.lower;
                    ...
                    else e = b.getFirst(function(b) { return c(a, b) });
                    if (f && b.contains(f))
                        for (; !f.getParent().equals(b);) f = f.getParent();
                    else f = b.getLast(function(b) { return c(a, b) });
                    if (!e || !f) return null;
                    r(a, e);
                    r(a, f);
                ...
                function c(a, b) { return !(b && b.type == CKEDITOR.NODE_TEXT || F(b) || u(b) || A(a, b) || b.type == CKEDITOR.NODE_ELEMENT && b.$ && b.is("br")) }
                return function(c) {
                    var b = a(c),
                        e;
                    if (e = b) {
        ...
        function v(a) {
            if (!a.editable().isInline()) {
                var e = CKEDITOR.instances,
                    f;
                for (f in e) { var b = e[f]; "wysiwyg" != b.mode || b.readOnly || (b = b.document.getBody(), b.setAttribute("contentEditable", !1), b.setAttribute("contentEditable", !0)) }
            ...
            init: function(a) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    ...
                    a.addCommand("maximize", {
                        ...
                        editorFocus: !1,
                        exec: function() {
                            var h = a.container.getFirst(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }),
        ...
        var c = {
            ...
            exec: function(a) {
                a.getClipboardData({ title: a.lang.pastetext.title }, function(b) {
                    b && a.fire("paste", { type: "text", dataValue: b.dataValue, method: "paste", dataTransfer: CKEDITOR.plugins.clipboard.initPasteDataTransfer() });
    ...
    CKEDITOR.plugins.add("menubutton", {
        ...
        onLoad: function() {
            ...
            CKEDITOR.ui.menuButton = CKEDITOR.tools.createClass({
                ...
                statics: { handler: { create: function(c) { return new CKEDITOR.ui.menuButton(c) } } }
            })
        },
    ...
    CKEDITOR.plugins.add("scayt", {
            ...
            var c = CKEDITOR.plugins.scayt,
                ...
                g = function() {
                    ...
                    c.attachListener(c, "mousedown", function(b) {
                        ...
                        d && (d.wrapper = b.getAscendant(function(a) { return a.hasAttribute("data-cke-widget-wrapper") }, !0))
                    }, this, null, -10)
                };
            a.on("contentDom", g);
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function(a) {
                    for (var b = [], d = 0; d < a.length; d++) {
                        var c = a[d],
                            m = !!g(a, "options");
                        if (!g(e, c) || m && g(f, function(a) { if ("lang" === a) return !1 })) return;
        ...
        addRule: function(a) {
            var c = CKEDITOR.plugins.scayt,
                ...
                g = function(b) { if (a.scayt && (b.hasAttribute(c.options.data_attribute_name) || b.hasAttribute(c.options.problem_grammar_data_attribute))) return !1 },
                h = function(b) {
                    var d = !0;
                ...
                if (d)
                    for (d = 0; d < c.length; d++) {
                        ...
                        d < a.config.scayt_maxSuggestions ? (a.addMenuItem(k, { label: c[d], command: k, group: "scayt_suggest", order: d + 1 }), b[k] = CKEDITOR.TRISTATE_OFF) : (a.addMenuItem(k, {
                            ...
                            order: d + 1
                        }), e[k] = CKEDITOR.TRISTATE_OFF, "on" === a.config.scayt_moreSuggestions && (a.addMenuItem("scayt_moresuggest", { label: h.getLocal("btn_moreSuggestions"), group: "scayt_moresuggest", order: 10, getItems: function() { return e } }), b.scayt_moresuggest = CKEDITOR.TRISTATE_OFF))
                    } else
    ...
    CKEDITOR.plugins.scayt = {
        ...
        replaceOldOptionsNames: function(a) { for (var c in a) c in this.backCompatibilityMap && (a[this.backCompatibilityMap[c]] = a[c], delete a[c]) },
        ...
        loadScaytLibrary: function(a,
            ...
            "undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (d = a.config.scayt_srcUrl + "?" + this.onLoadTimestamp, CKEDITOR.scriptLoader.load(d, function(a) { a && b() })) : window.SCAYT && "function" === typeof window.SCAYT.CKSCAYT && b()
        }
    };
    CKEDITOR.on("dialogDefinition", function(a) {
        var c = a.data.name;
        a = a.data.definition.dialog;
        if ("scaytDialog" === c) a.on("cancel", function(a) { return !1 }, this, null, -1);
    ...
    CKEDITOR.dom.element.prototype.focusNext = function(k, h) {
        ...
        if (0 >= g)
            for (b = this.getNextSourceNode(k, CKEDITOR.NODE_ELEMENT); b;) {
                if (b.isVisible() && 0 === b.getTabIndex()) { d = b; break }
    ...
    CKEDITOR.plugins.add("table", {
        requires: "dialog",
        init: function(a) {
            function e(b) { return CKEDITOR.tools.extend(b || {}, { contextSensitive: 1, refresh: function(b, a) { this.setState(a.contains("table", 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED) } }) }
            if (!a.blockless) {
                var c = a.lang.table;
    ...
    (function() {
        ...
        function z(e, d, b) { e = e[d]; if ("undefined" == typeof b) return e; for (d = 0; e && d < e.length; d++) { if (b.is && e[d] == b.$) return d; if (d == b) return new CKEDITOR.dom.element(e[d]) } return b.is ? -1 : null }
        ...
        function A(e, d) {
            ...
            if (1 < k) {
                ...
                for (var k = Math.floor(k /
                    ...
                    if (n = f[g], n.parentNode == a.$ && g > h) { c.insertBefore(new CKEDITOR.dom.element(n)); break } else n = null;
                n || a.append(c)
            } else
        ...
        CKEDITOR.plugins.tabletools = {
            ...
            init: function(e) {
                function d(a) { return CKEDITOR.tools.extend(a || {}, { contextSensitive: 1, refresh: function(a, b) { this.setState(b.contains({ td: 1, th: 1 }, 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED) } }) }
                ...
                b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", d({
                    ...
                    requiredContent: "table",
                    contentTransformations: [
                        [{ element: "td", left: function(a) { return a.styles.background && a.styles.background.match(/^(#[a-fA-F0-9]{3,6}|rgb\([\d, ]+\)|\w+)$/) }, right: function(a) { a.styles["background-color"] = a.styles.background } }]
                    ]
                })));
    ...
    CKEDITOR.tools.buildTableMap = function(t) {
        ...
        for (var p = -1, u = [], v = 0; v < t.length; v++) {
            ...
            for (var m = -1, y = 0; y < t[v].cells.length; y++) {
                var x = t[v].cells[y];
                for (m++; u[p][m];) m++;
                for (var q = isNaN(x.colSpan) ? 1 : x.colSpan, x = isNaN(x.rowSpan) ? 1 : x.rowSpan, z = 0; z < x; z++) { u[p + z] || (u[p + z] = []); for (var w = 0; w < q; w++) u[p + z][m + w] = t[v].cells[y] }
                m += q - 1
            }
        }
        return u
